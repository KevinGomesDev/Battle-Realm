 ...
 */
export function getAIUnits(battle: BattleSession): BattleUnit[] {
 ...
 */
export function hasActiveAIUnits(battle: BattleSession): boolean {
 ...
 */
export function isAITurn(battle: BattleSession): boolean {
 ...
 * Suporta tanto Battle (servidor) quanto BattleSession (client)
...
export function createBattleContext(
  ...
  const battleId = (battle as BattleSession).battleId || (battle as any).id;
 ...
 */
export function checkVictoryIgnoringAI(battle: BattleSession): string | null {
