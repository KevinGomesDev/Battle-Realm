...
/**
 * BattleLobby - Lobby compacto para Battle PvP (Dashboard)
 */
    ...
    <div className="space-y-3">
      ...
      <div className="space-y-2">
        ...
        {hostPlayer && (
          ...
          >
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 bg-linear-to-b from-stellar-amber to-stellar-dark rounded flex items-center justify-center text-xs">
                👑
              </div>
        ...
        {otherPlayers.map((player) => (
          ...
          >
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 bg-linear-to-b from-red-500 to-red-800 rounded flex items-center justify-center text-xs">
                ⚔️
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-xs font-semibold text-astral-chrome truncate">
