// client/src/features/battle/components/QTEOverlay.tsx
...
export const QTEOverlay: React.FC<QTEOverlayProps> = ({
  ...
  useEffect(() => {
    if (!config || hasResponded || !isResponder) return;
  ...
  }, [config?.qteId, hasResponded, isResponder]);
...
// =============================================================================
// CSS KEYFRAMES (adicionar ao index.css ou como style tag)
// =============================================================================
